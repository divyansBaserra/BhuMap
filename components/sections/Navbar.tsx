...
export default function Navbar({ isLoggedIn, onWorkspaceAccess, onLogout, onOpenAuth }: NavbarProps) {
  ...
  return (
    <nav className="relative z-20 max-w-[1400px] mx-auto px-6 pt-8 pb-6 flex items-center justify-between">
      <Link href="/" className="nav-elem flex items-center gap-3 cursor-pointer">
      ...
      <div className="hidden md:flex items-center gap-10">
        {/* Using Next.js Link for instant routing without reloads */}
        <Link href="/about" className="nav-elem text-[15px] font-semibold text-[#1c2b23]/70 dark:text-white/70 hover:text-[#5b8c69] dark:hover:text-[#5b8c69] transition-colors cursor-pointer">Platform</Link>
        <Link href="/features" className="nav-elem text-[15px] font-semibold text-[#1c2b23]/70 dark:text-white/70 hover:text-[#5b8c69] dark:hover:text-[#5b8c69] transition-colors cursor-pointer">Features</Link>
        <Link href="/process" className="nav-elem text-[15px] font-semibold text-[#1c2b23]/70 dark:text-white/70 hover:text-[#5b8c69] dark:hover:text-[#5b8c69] transition-colors cursor-pointer">How it works</Link>
        <Link href="/faq" className="nav-elem text-[15px] font-semibold text-[#1c2b23]/70 dark:text-white/70 hover:text-[#5b8c69] dark:hover:text-[#5b8c69] transition-colors cursor-pointer">FAQ</Link>
      </div>
